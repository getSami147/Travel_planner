...
//   mList.add(NotificationModel("HouseHold", "now",
//       "Lorem Ipsum is simply dummy text of the printing and typesetting industry."));
//   mList.add(NotificationModel("Grocery", "4 min ago",
//       "Lorem Ipsum is simply dummy text of the printing and typesetting industry."));
//   mList.add(NotificationModel("Chilled", "30 min ago",
//       "Lorem Ipsum is simply dummy text of the printing and typesetting industry."));
//   return mList;
// }
...
//   mList.add(ReviewModel(
//       "Ella White", "Today", "Greate quality & Fresh", grocery_ic_user1));
//   mList.add(ReviewModel(
//       "Lily Williams", "Yesterday", "Good Quality", grocery_ic_user2));
...
//   var list1 = GroceryPaymentModel(grocery_ic_visa, grocery_blue,
//       "Ishan Maduskha", "**** **** **** 4567", true);
//   list.add(list1);

//   var list2 = GroceryPaymentModel(
//       grocery_ic_masterCard,
